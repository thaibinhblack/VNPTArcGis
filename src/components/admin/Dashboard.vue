      ...
      <mdb-row>
        <mdb-col xl="4" md="4" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              <div class="progress">
                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="90%" class="progress-bar bg-primary" role="progressbar"
                  style="width: 90%"></div>
              </div>
          ...
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              <div class="progress">
                ...
                <mdb-card-text>Tổng số cây chết (5%)</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
        <mdb-col xl="4" md="4" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Tổng số cây bệnh (5%)</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
